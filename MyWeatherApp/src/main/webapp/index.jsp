...
<head>
    ...
    <title>Weather App - CodingWallahSir</title>
     ...
     <link rel="shortcut icon" href="images/letter-w.png" type="image/x-icon">
</head>
<body>

	
 <!-- Weather Icon on the top left side -->
  <div class="weather-icon-container">
    <i class="fas fa-cloud-sun fa-3x" style="color: #FEC84D;"></i> <!-- Example weather icon -->
  </div>
